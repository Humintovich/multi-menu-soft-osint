#!/usr/bin/env python3
# FPYTHONSOCIAL v9.0 - Red digital rain 5s at startup, purple menu
...
# ===== КРАСНЫЙ ЦИФРОВОЙ ДОЖДЬ (5 СЕКУНД) =====
rain_running = True
...
def print_header():
    ...
    print(f"{PURPLE_BOLD}   FPYTHONSOCIAL v9.0     {PURPLE_DIM}by {AUTHOR}{RESET}")
    print(f"{PURPLE_BOLD}{'═'*60}{RESET}")
